package org.geoconvertor.datum;

/**
 * @(#)Datum.java	0.1 07/05/2010 
 * 
 ...
 * 
 * <p>
 * Enum Class indicates that the DATUM with coordinate system associated with the object.
 * 
 * </p>
 * 
...
public enum Datum {
	/**
	 * 
	 * Indicates that the DATUM type {@SAD69} and (@WGS84).
	 *
	 */
	SAD69, WGS84
}
